...
class Element:
    ...
    def add_distributed_load(self, q):
        ...
        self.local_element_load =[0, 0, 0, 0, 0, 0]

        global_element_load = np.matmul(self.Tt, self.local_element_load)

        self.nodes[0].add_load(global_element_load[0], global_element_load[1], global_element_load[2])
        self.nodes[1].add_load(global_element_load[3], global_element_load[4], global_element_load[5])
